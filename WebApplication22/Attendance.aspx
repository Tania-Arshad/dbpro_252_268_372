...
&nbsp;<div class="controls">
                                ...
                                <br />
                                Date</label>&nbsp;<input type="text" id="inputDate" placeholder="Date" />
                                <label class="control-label" for="inputLname" style="height: 118px; width: 333px;">
                                Status<br />
                        ...
                        <div class="control-group">
                            <div class="controls" style="height: 46px; margin-top: 181px">
                                ...
                                <input class="btn btn-large btn-success" type="submit" value="Add" style="width: 85px" />
                                <input class="btn btn-large btn-success" type="submit" value="Update" style="width: 91px" /><input class="btn btn-large btn-success" type="submit" value="Delete" style="width: 85px; margin-left: 0.8em;" /><br />
                            </div>
                        </div>
                    </div>
